...
(DEFAULT, 'Мне кажется или я уже читал это где-то?', '2020-02-22 01:08:14', 3, 2),
(DEFAULT, 'Это где ж такие красоты?', '2019-02-01 10:48:27', 4, 2),
(DEFAULT, 'Хочу такую же футболку :-)', '2019-11-17 04:12:52', 5, 3),
(DEFAULT, 'Планируете записать видосик на эту тему?', '2019-11-02 04:12:52', 1, 3);
