...
module.exports = {
  Article: {
    ...
    MAX_IMAGE_NAME_LENGTH: `Название изображения не может содержать больше 150 символов`,
    DATE_FORMAT: `Укажите дату согласно стандарту ISO 8601`,
    DATE_REQUIRED: `Выберите дату публикации`,
  },
  Comment: {
    MIN_TEXT_LENGTH: `Комментарий должен содержать не меньше 20 символов`,
  ...
  User: {
    ...
    MIN_REPEAT_PASSWORD_LENGTH: `Поле повторение пароля должно содержать не менее 6 символов и совпадать с паролем`,
